...
public class CnaWorldBaseServiceImpl<M extends CnaworldBaseMapper<T>, T> implements CnaworldBaseService<T> {
	...
	protected Class<M> currentMapperClass() {
        return (Class<M>) ReflectionKit.getSuperClassGenericType(this.getClass(),CnaWorldBaseServiceImpl.class, 0);
    }

    protected Class<T> currentModelClass() {
        return (Class<T>) ReflectionKit.getSuperClassGenericType(this.getClass(),CnaWorldBaseServiceImpl.class, 1);
    }
